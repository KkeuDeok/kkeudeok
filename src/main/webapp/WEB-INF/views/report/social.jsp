...
<%-- 2026-08-10 피드백 5 — 사회성만 척도가 다르다(팀장 확정: SRS-2).
     ⚠ 성공률이 아니라 **환산 점수**다. 아래 레이더 5축 단순평균(60)과 값이 다른 건
     원점수를 표준점수로 환산하기 때문 — SRS-2 의 실제 계산 방식이라 오류가 아니다.
     내려간 이유를 같이 적어야 "왜 떨어졌냐"에 답이 된다. --%>
<p class="rpt-basis">SRS-2 5개 축 응답을 환산한 점수 · 61점 → 58점 · 성실성 41점이 가장 낮았어요</p>
