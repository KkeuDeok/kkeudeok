...
<link href="/css/kkeudeok.css?v=125" rel="stylesheet">
<link href="/css/auth.css?v=125" rel="stylesheet">
<link href="/css/onboarding.css?v=125" rel="stylesheet">
<link href="/css/app.css?v=125" rel="stylesheet">
<link href="/css/report.css?v=125" rel="stylesheet">
<link href="/css/mypage.css?v=125" rel="stylesheet">
<link href="/css/child.css?v=125" rel="stylesheet">
...
<script src="/js/fit-frame.js?v=125"></script>
<script src="/js/auth-validate.js?v=125" defer></script>
<script src="/js/onb-select.js?v=125" defer></script>
<%-- kd-roadmap.js 는 onb-select.js 가 노출하는 kdBuildSelects 를 쓰므로 반드시 뒤에 둔다 --%>
<script src="/js/kd-roadmap.js?v=125" defer></script>
