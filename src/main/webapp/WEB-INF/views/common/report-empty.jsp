...
<%-- 성장 리포트 5탭 공통 — 관찰 데이터가 0일 때 본문 대신 뜨는 안내.
     본문(.rpt-score/.rpt-sec/...)은 report.css 의 html[data-kd-empty] 규칙이 통째로 숨긴다.
     탭바는 그대로 살려 둔다 — 어떤 리포트가 생기는지는 미리 보여 주는 편이 낫다. --%>
<div class="rpt-empty kd-no-data">
    <div class="kd-empty">
        <span class="ic kd-empty-ic-seed"></span>
        <p class="t">성장 리포트는 첫 주 학습이 끝나면 만들어져요</p>
        <p class="d">이번 주 0 / 3회 · 세 번을 채우면 감정 이해 · 표현 · 사회성 지수가 처음 계산돼요</p>
